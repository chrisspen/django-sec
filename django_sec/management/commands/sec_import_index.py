...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--start_year', default=None, dest='start_year', action='store_true')
        parser.add_argument('--end_year', default=None, dest='end_year', action='store_true')
        parser.add_argument('--quarter', default=None, dest='quarter', action='store_true')
        ...
        parser.add_argument('--auto-reprocess-last-n-days', help='The number of days to automatically redownload and reprocess index files.', default=90, dest='auto_reprocess_last_n_days', action='store_true')
